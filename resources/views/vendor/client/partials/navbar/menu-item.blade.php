...
@if ($navbarItemHelper->isSearch($item))
    ...
    {{-- Search form --}}
    @include('vendor.client.partials.navbar.menu-item-search-form')
...
@elseif ($navbarItemHelper->isFullscreen($item))
    ...
    @include('vendor.client.partials.navbar.menu-item-fullscreen-widget')
...
@elseif ($navbarItemHelper->isSubmenu($item))
    ...
    {{-- Dropdown menu --}}
    @include('vendor.client.partials.navbar.menu-item-dropdown-menu')

@elseif ($navbarItemHelper->isLink($item))

    {{-- Link --}}
    @include('vendor.client.partials.navbar.menu-item-link')
